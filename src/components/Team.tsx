...
const categories = ['all', 'personal', 'client', 'academic', 'ia'];
...
export default function Projects() {
  ...
  const getVisibleProjects = () => {
    ...
    const p = (currentIndex - 1 + filteredProjects.length) % filteredProjects.length;
    const n = (currentIndex + 1) % filteredProjects.length;
    return [filteredProjects[p], filteredProjects[currentIndex], filteredProjects[n]];
  };
