...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'footer.role': 'développeur frontend & ai', 'footer.rights': 'All rights reserved.', 'footer.made': 'Made with', 'footer.by': 'by NRBH',
  ...
  en: {
    ...
    'footer.role': 'Frontend Developer & AI', 'footer.rights': 'All rights reserved.', 'footer.made': 'Made with', 'footer.by': 'by NRBH',
    'status.completed': 'Completed', 'status.in-progress': 'In Progress', 'status.collaboration': 'Open for Collaboration'
  }
};
